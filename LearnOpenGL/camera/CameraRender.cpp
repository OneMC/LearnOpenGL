...
// timing
static float deltaTime = 0.1f;    // time between current frame and last frame
...
void CameraRender::setup() {
    ...
    _shader = new Shader(ResPath("/LearnOpenGL/camera/camera_vertex.vs"),
                         ResPath("/LearnOpenGL/camera/camera_fragment.fs"));
    _shader->use();
...
void CameraRender::processInput(GLFWwindow *window) {
...
// -------------------------------------------------------
void CameraRender::mouse_callback(GLFWwindow* window, double xposIn, double yposIn) {
...
// ----------------------------------------------------------------------
void CameraRender::scroll_callback(GLFWwindow* window, double xoffset, double yoffset) {
    fov -= (float)yoffset;
    if (fov < 1.0f)
        fov = 1.0f;
    if (fov > 45.0f)
