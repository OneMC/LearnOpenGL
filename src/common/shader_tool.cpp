...
unsigned int setupCubeVertex() {
    ...
    glBufferData(GL_ARRAY_BUFFER,
                 sizeof(CameraRenderVertex),
                 CameraRenderVertex, GL_STATIC_DRAW);
...
unsigned int setupCubeVertexNormal() {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(float) * 216, &CubeNormalVertices, GL_STATIC_DRAW);
    glEnableVertexAttribArray(0);
...
unsigned int setupCubeVertexMSAA() {
    ...
    glBindVertexArray(cubeVAO);
    glBindBuffer(GL_ARRAY_BUFFER, cubeVBO);
    glBufferData(GL_ARRAY_BUFFER, sizeof(CubeVerticesMSAA), &CubeVerticesMSAA, GL_STATIC_DRAW);
    glEnableVertexAttribArray(0);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
    glBindVertexArray(0);
    return cubeVAO;
